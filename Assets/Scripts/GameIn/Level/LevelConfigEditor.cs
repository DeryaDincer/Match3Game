...
public class LevelConfigEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
           levelSettings.BoardSpawnControllerSettings.gridStartLayout = new GridStartLayout((int)levelSettings.BoardSpawnControllerSettings.Width, (int)levelSettings.BoardSpawnControllerSettings.Height);
        }
    }
}